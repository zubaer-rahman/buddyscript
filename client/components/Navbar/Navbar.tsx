...
export default function Navbar() {
  ...
  const displayName = isMounted && user ? user.firstName + " " + user.lastName : "User";
  const avatarSrc = isMounted ? getUserAvatar(user) : getUserAvatar(null);
            ...
            <li className="nav-item _header_nav_item">
              ...
              >
                ...
                <div
                  id="_notify_drop"
                  className={
                    "_notification_dropdown" + (notifyDropOpen ? " show" : "")
                  }
                >
